...
requireLogin();
requireRole('kepala_sekolah'); // Memastikan hanya pemilik yang bisa akses
...
$stmt_gaji = $conn->prepare(
    "SELECT g.*, k.nama_lengkap, k.id as guru_id, j.nama_jabatan, k.tanggal_masuk 
     FROM gaji g 
...
<div class="bg-white p-8 rounded-xl shadow-lg max-w-3xl mx-auto border border-gray-200">
    <div class="text-center mb-8">
        <h2 class="text-3xl font-bold font-poppins text-gray-800">DETAIL GAJI KARYAWAN</h2>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-end pt-6">
            <a href="penggajian_pemilik.php" class="px-6 py-2.5 rounded-lg text-gray-600 bg-gray-100 hover:bg-gray-200 font-semibold text-sm transition-colors">Kembali ke Daftar Persetujuan</a>
        </div>
    </div>
</div>
