...
// Build query
$sql = "SELECT p.id_penggajian, g.nama_guru, j.nama_jabatan, p.tgl_input, p.bulan_penggajian,
...
$title_filter = '';
if (!empty($filter_jabatan)) {
    $jabatan_name = $conn->query("SELECT nama_jabatan FROM Jabatan WHERE id_jabatan = '$filter_jabatan'")->fetch_assoc()['nama_jabatan'];
    $title_filter .= $jabatan_name . ' - ';
}
if (!empty($filter_bulan)) {
...
<body>
    ...
    <div class="header">
        ...
        <div class="address">Jl. Raya Kretek, Bantul, Daerah Istimewa Yogyakarta</div>
    </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 8%;">ID Penggajian</th>
                    ...
                    <th style="width: 6%;">Pot. Terlambat</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-right">Rp <?= number_format($row['potongan_terlambat'] ?? 0, 0, ',', '.') ?></td>
                ...
                <tr style="background-color: #f8f9fa; font-weight: bold;">
                    ...
                    <td class="text-right">Rp <?= number_format(array_sum(array_column($data_rows, 'potongan_terlambat')), 0, ',', '.') ?></td>
