...
<div class="bg-white p-6 rounded-xl shadow-lg">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm text-left text-gray-700">
            ...
            <tbody>
                <?php $res = $conn->query("SELECT p.*, j.nama_jabatan FROM Potongan p JOIN Jabatan j ON p.id_jabatan = j.id_jabatan ORDER BY j.nama_jabatan"); $no=1; while($row = $res->fetch_assoc()): ?>
